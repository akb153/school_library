...
public class BookSearchResult extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		//String start_year = request.getParameter("keyword");
		//String end_year = request.getParameter("keyword");
		...
		try {
			...
			// index.jspへ転送
			request.getRequestDispatcher("/WEB-INF/view/book_search_result.jsp").forward(request, response);
