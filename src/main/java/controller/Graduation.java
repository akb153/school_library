 ...
 */
@WebServlet("/Graduation")
public class Graduation extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//ユーザーリストを取得してSessionにセットしておく
		ArrayList<LoginBean> userList = new ArrayList<LoginBean>();
		try {
			userList = UserOperation.getUserList();
		...
		// admission.jspへ転送
		request.getRequestDispatcher("/WEB-INF/view/graduation.jsp").forward(request, response);
	}
